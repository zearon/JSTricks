            ...
            else if (requestMethod == "JSTinjectScript")
            {
				...
				try {
					...
					autoloadFileList.unshift(
						{name:"boot/jquery", file:"boot.js", type:"js"},
