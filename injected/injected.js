(function() {
  if (window.__JSTricks_Injected_removeEvent)
    return;

  window.__JSTricks_Injected_removeEvent = __JSTricks_Injected_removeEvent;
  window.__JSTricks_Injected_enableRightClick = __JSTricks_Injected_enableRightClick;
